 ...
 * <p>
 * Purpose - The Start Button.java class is the class that represents the Start button explained in
 * the README
 * <p>
 ...
 */
public class StartButton extends SimulationButton {
   ...
   */
  public StartButton(String prop, ResourceBundle resources, Grid[] model,
      SimulationView[] display) {
    super(prop, resources, model, display);
    this.setOnAction(event -> Main.setIsRunning(true));
  }
}
